...
enum AHCICommandIDs {
  AHCI_COMMAND_NUM_DEVICES,  // input_buffer is NULL,
                             // output_buffer is uint64_t *
  AHCI_COMMAND_DEVICE_INFO,  // input_buffer is struct AHCIDeviceInfo *,
                             // output_buffer is struct AHCIDeviceInfo *
  AHCI_COMMAND_READ,         // input_buffer is struct AHCIReadCommand *,
                             // output_buffer will contain read data
  AHCI_COMMAND_WRITE         // input_buffer is struct AHCIWriteCommand *
                             // output_buffer contains data to write
};
